...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 19 avr. 2024 à 21:00
...
INSERT INTO `cart_details` (`id_cart`, `id_film`, `title`, `price`, `id_lignes`) VALUES
(1, 27, 'Nos cœurs meurtris', 2.99, 11),
(1, 29, 'Les Misérables', 2.99, 10),
(1, 28, 'A Star Is Born', 2.99, 9),
(1, 30, 'Rush', 2.99, 8),
(5, 1, 'Top Gun', 2.99, 12);
