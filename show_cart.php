...
<a class="navbar-brand" href="../">Tetanos</a>
    ...
    <div style="margin-right: 500px">
        <h5 style="color: #545659; opacity: 0.5;">Connecté en tant que: <?= $_SESSION['pseudo'] ?></h5>
    </div>
...
<?php foreach($Details as $detail ): ?>
                ...
                <td><a href="del_cart.php?id=<?=$detail ->id_lignes?>"><i class="fa fa-pencil" style="font-size: 30px;"></i></a></td>
